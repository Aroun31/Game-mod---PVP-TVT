#include "..\..\DA3F_macros.hpp"
    ...
    */
    ...
    private _BTSD_ArrPosWest	= Cfg_MissionInfo(getArray,"west","PosStartQg");
    private _BTSD_ArrPosEast	= Cfg_MissionInfo(getArray,"east","PosStartQg");
    private _BTSD_PosWest       = selectRandom _BTSD_ArrPosWest;
    private _BTSD_PosEast       = selectRandom _BTSD_ArrPosEast;
