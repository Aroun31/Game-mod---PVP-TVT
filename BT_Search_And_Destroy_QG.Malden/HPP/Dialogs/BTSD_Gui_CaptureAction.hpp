class BTSD_CaptureAction
{
	...
	OnLoad	= "hint ""Déplacez le menu à votre convenance \n\n cliquez dessus et relâchez le clic à la position voulu."" ";
	...
	class controls
	{
		class CloseBtn: DA3F_Btn_Close
		{
			...
			h = 0.028 * safezoneH;
			colorBackground[] = {0.95, 0.05, 0.05, 0.75};
			colorBackground2[] = {0, 0, 0, 0.75};
			color[] = {0, 0, 0, 1};
		};
		...
		class DA3F_Btn_01: DA3F_Btn
		{
			...
			h = 0.042 * safezoneH;
			colorBackground[] = {0.1, 0.75, 0.2, 0.85};
			color[] = {0, 0, 0, 0.95};
